...
json_string = str(product_detail2)
...
LLM_promptProductDescription = json_string + productDescriptionPrompt
LLM_promptTargetAudiance = json_string + targetAudiancePrompt
